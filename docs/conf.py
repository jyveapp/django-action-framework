# -*- coding: utf-8 -*-
#
# django-action-framework documentation build configuration file, created by
...
project = u'django-action-framework'
...
htmlhelp_basename = 'django-action-frameworkdoc'
...
latex_documents = [
    (
        ...
        u'django-action-framework Documentation',
        u'Jyve',
        'manual',
    )
]
